 ...
 * @throws A `TypeError` if the values `a` and `b` are equal.
 */
declare function assertDifferent<T = unknown, U = unknown>(a: T, b: U, name1: string): void;
/**
 * Compares two values and throws an error if they are equal.
 *
 * @template T The type of the first value being compared.
 ...
 * @throws A `TypeError` if the values `a` and `b` are equal.
 */
declare function assertDifferent<T = unknown, U = unknown>(a: T, b: U, name1: string, name2: string): void;
/**
 * Compares two values and throws an error if they are equal.
 *
 * @template T The type of the first value being compared.
 ...
 * @throws A `TypeError` if the values `a` and `b` are equal.
 */
declare function assertDifferent<T = unknown, U = unknown>(a: T, b: U, name1: string, name2: string, comparator: (a: T, b: U) => boolean): void;
